...
namespace ToDoList
{
  public class Category
  {
    ...
    public void Delete()
    {
      ...
      SqlCommand cmd = new SqlCommand("DELETE FROM categories WHERE id = @CategoryId; DELETE FROM categories_tasks; DELETE FROM tasks WHERE category_id = @CategoryId;", conn);
